...
const inviteSchema = z.object({
  ...
  role: z.enum(["super_admin", "subeb_admin", "aeo", "head_teacher", "principal", "sso", "teacher"]),
...
const ROLE_COLORS: Record<string, string> = {
  ...
  aeo:          "text-indigo-700 border-indigo-300 bg-indigo-50 dark:bg-indigo-950/40",
                  ...
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} value={field.value}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="aeo">Area Education Officer (AEO)</SelectItem>
